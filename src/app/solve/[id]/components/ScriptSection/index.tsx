    ...
    <div className="relative px-5 py-6  bg-[#F8F3FF] text-indigo-800 rounded-[10px] h-[438px]">
      ...
      {isLoading ? (
        ...
        <div className="whitespace-pre-wrap flex">
          {script ? (
            <p className="text-[16px] text-[#424242] leading-7 sm:text-lg font-normal">{script}</p>
          ) : (
            <p
              className="text-base font-bold text-gray-500 cursor-pointer hover:opacity-50"
