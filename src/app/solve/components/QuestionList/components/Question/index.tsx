    ...
    <Link href={`/solve/${id}`}>
      <div className="flex flex-col bg-[#FAFAFA] rounded-lg px-5 py-4 gap-5 cursor-pointer hover:opacity-70 dark:bg-indigo-950 dark:border-indigo-800">
        <div>
          ...
          <h2 className="text-[#212121] text-[18px] sm:text-2xl font-bold leading-5 dark:text-slate-100">
            {title}
          </h2>
        </div>
        <p className="text-[#616161] text-[12px] sm:text-lg mt-2 font-semibold leading-3">
          👥{" "}
